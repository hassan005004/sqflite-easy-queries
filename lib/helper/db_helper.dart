// /*
// * Missing
// * BEGIN TRANSACTION; and COMMIT; not done
// * Alter table name
// * Drop Column
// *
// * Select Distinct
// * Joins <<>> please work on it
// * Having
// * Union
// * Expects
// * Case
// * Replace
// * Transaction <<>> please work on it
// * Where implementation testng on Date/Time
// * AVG, MAX, MIN, SUM
// * */
//
...
//
//
//   MyDb hasOne(MyDb model, key, foreignKey){
//     // model.where(foreignKey)
//     // print(1);
//     return this;
//   }
//   // MyDb withHasOne({table, key, foreignKey}){
//   //   return this;
//   // }
//
//   // Use to make statement.
//   MyDb select(List list){
//     select_paramters = list.join(', ');
//     return this;
//   }
//   MyDb table(String table){
//     tableName = table;
//     return this;
//   }
//   MyDb joining(String join){
//     if(join_statement == ''){
//       join_statement = join;
//       return this;
//     }
...
//     return this;
//   }
//   MyDb limit(int number){
//     if(limit_result == ''){
//       limit_result = 'Limit $number';
//     }
//     return this;
//   }
//   MyDb skip(int number){
//     // if(offset == ''){
...
//   // }
//
//   // MyDb insert(Map<String, dynamic> map){
//   //   queryResult = callInsertQuery([map]);
//   //   return this;
//   // }
//
//   // MyDb insertArray(List<Map<String, dynamic>> map){
...
//     return this;
//   }
//   // MyDb update(Map<String, dynamic> map){
//   //   queryResult = callUpdateQuery(map);
//   //   return this;
//   // }
//
//
//   MyDb addColumn({required name, required ColumnType type, isNUll = false, isPrimaryKey = false, isAutoIncrement = false}){
...
//     return this;
//   }
//   MyDb renameColumn({required oldName, required newName}){
...
//     return this;
//   }
//   MyDb renameTable({required oldName, required newName}){
...
//   MyDb whereFunc(type, col, operator, value, {callbackLevel = 0}){
...
//     return this;
//   }
//   MyDb whereInFunc(type, col, _list, {callbackLevel = 0}){
...
//     return this;
//   }
//   MyDb whereNotInFunc(type, col, _list, {callbackLevel = 0}){
//     String list = "( " + _list.join(', ') + " )";
//     if(callbackLevel == 0 && where_conditions == ''){
...
//     return this;
//   }
//   MyDb whereBetweenFunc(type, col, _list, {callbackLevel = 0}){
//     String val1 = _list[0];
//     String val2 = _list[1];
//     if(callbackLevel == 0 && where_conditions == ''){
...
//     return this;
//   }
//   MyDb whereNulFunc(type, col, {callbackLevel = 0}){
//     if(callbackLevel == 0 && where_conditions == ''){
...
//     // insert all records
//     var db = await openDatabase(db_name);
//     final a = await db.rawInsert("INSERT INTO `$tableName` $columnsString VALUES $bufferString;");
//     // print(a);
//     // await db.close();
//   }
//
